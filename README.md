...
- 12 new tests cover extraction, adversarial cases (keyword beyond 1000 chars, longer non-Overview blocks), concurrency bounds, timing, and matched-keyword visibility.
