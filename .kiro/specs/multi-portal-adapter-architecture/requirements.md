...
- **Live_Sheet_Schema**: The canonical 14-column Google Sheets schema (v1.1): (1) `portal_source`, (2) `opportunity_title`, (3) `funder_organisation`, (4) `country_region`, (5) `deadline`, (6) `contract_value`, (7) `opportunity_link`, (8) `summary`, (9) `relevance_score`, (10) `bid_recommendation`, (11) `risk_flags`, (12) `review_status`, (13) `scraped_at`, (14) `matched_keywords`. Writing is header-name-driven (not positional). Historical schema v1.0 was 12 columns without `scraped_at` or `matched_keywords`. `scraped_at` is the UTC discovery timestamp (ISO 8601 with Z suffix); `matched_keywords` is the authoritative JSON array of filter-matched terms. Historical blank values in these columns remain valid for Tool 2 readers. Tool 2 reads rows by header name and performs its own grouping/filtering; it does not recompute `matched_keywords`.
